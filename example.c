...
#define __xorxor__OUTPUT_2(__xorxor__INPUT_1, __xorxor__INPUT_2) OUTPUT(__xorxor__xor_3(__xorxor__INPUT_1, __xorxor__INPUT_2))
#define xorxor(__xorxor__INPUT_1, __xorxor__INPUT_2) __xorxor__OUTPUT_1(__xorxor__INPUT_1, __xorxor__INPUT_2), __xorxor__OUTPUT_2(__xorxor__INPUT_1, __xorxor__INPUT_2)
