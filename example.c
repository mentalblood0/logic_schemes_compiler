...
#define __MAIN__OUTPUT_1(__MAIN__INPUT_1, __MAIN__INPUT_2) OUTPUT(NTH_2(__MAIN__xor_3(__MAIN__INPUT_1, __MAIN__INPUT_2)))
#define MAIN(__MAIN__INPUT_1, __MAIN__INPUT_2) __MAIN__OUTPUT_1(__MAIN__INPUT_1, __MAIN__INPUT_2)
#define test_MAIN ((NTH_1(MAIN(0, 0)) == 1) && (NTH_1(MAIN(1, 0)) == 1) && (NTH_1(MAIN(0, 1)) == 1) && (NTH_1(MAIN(1, 1)) == 1))
...
#define __xor__NOT_3(__xor__INPUT_1, __xor__INPUT_2) NOT(__xor__AND_1(__xor__INPUT_1, __xor__INPUT_2))
#define __xor__OUTPUT_2(__xor__INPUT_1, __xor__INPUT_2) OUTPUT(__xor__NOT_3(__xor__INPUT_1, __xor__INPUT_2))
...
#define test_xor ((NTH_1(xor(0, 0)) == 0) && (NTH_2(xor(0, 0)) == 1) && (NTH_1(xor(1, 0)) == 1) && (NTH_2(xor(1, 0)) == 0) && (NTH_1(xor(0, 1)) == 1) && (NTH_2(xor(0, 1)) == 0) && (NTH_1(xor(1, 1)) == 0) && (NTH_2(xor(1, 1)) == 1))
